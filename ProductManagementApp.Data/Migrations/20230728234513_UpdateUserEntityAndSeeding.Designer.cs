...
namespace ProductManagementApp.Data.Migrations
{
    ...
    [Migration("20230728234513_UpdateUserEntityAndSeeding")]
    partial class UpdateUserEntityAndSeeding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProductManagementApp.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Poole",
                            MiddleName = "",
                            PasswordHash = new byte[] { 146, 181, 198, 78, 154, 237, 193, 123, 199, 128, 211, 107, 85, 7, 226, 9, 168, 98, 31, 200, 196, 1, 133, 94, 231, 59, 224, 179, 101, 179, 28, 209, 27, 91, 140, 130, 225, 55, 210, 111, 13, 140, 76, 84, 126, 198, 121, 222, 21, 242, 33, 238, 233, 119, 129, 211, 30, 163, 15, 87, 6, 118, 142, 142 },
                            PasswordSalt = new byte[] { 98, 159, 179, 33, 211, 211, 158, 96, 32, 15, 17, 210, 73, 163, 12, 153, 210, 156, 2, 91, 159, 17, 214, 248, 83, 153, 181, 184, 133, 188, 240, 207, 117, 153, 166, 6, 126, 204, 214, 68, 7, 144, 232, 128, 27, 122, 103, 213, 63, 95, 3, 100, 180, 33, 38, 86, 1, 12, 156, 140, 38, 153, 75, 196 },
                            Phone = "(878) 577-3238",
                            Role = 2,
                            UpdatedBy = new Guid("4af36f59-a750-4d33-ab0a-c29e59defe11"),
                            UpdatedDate = new DateTimeOffset(new DateTime(2023, 7, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
